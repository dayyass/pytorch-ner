...
dataset_preprocessed = NERDataset(token_seq=token_seq, label_seq=label_seq, token2idx=token2idx, label2idx=label2idx)
...
ref_labels_0 = np.array(6)
ref_lengths_0 = np.array([0, 0, 0, 0, 0, 1])

ref_tokens_1 = np.array([8, 3, 4, 5, 9, 7])
ref_labels_1 = np.array(6)
ref_lengths_1 = np.array([0, 0, 0, 0, 0, 1])
